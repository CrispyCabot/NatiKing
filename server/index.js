...
// Mongoose methods
const uri = `mongodb+srv://natiking:${encodeURI(process.env.MONGO_ATLAS_PASSWORD)}@cluster0.aw5gd.mongodb.net/${encodeURI(process.env.MONGO_ATLAS_DB)}?retryWrites=true&w=majority`;
